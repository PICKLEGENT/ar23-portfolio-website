...
const HomeProjectCard = ({ title }: HomeProjectCardProps) => {
    return (
        <Link to='/project' className="flex justify-between items-center my-60 p-2.5 text-primary-black border border-primary-black rounded-2xl bg-primary-white shadow-drop">
